...
**Architecture:** Workspace 的 widget layout view state 已由 02 集中；本階段完成其餘 domain lifecycle 與全域殘留，最終零 React instance 控制。
...
**Prerequisite:** 03–07 全部 task，以及 U1a/U1b 宣告式 `view` contract；[09 regression gates](09-regression-gates.md) 全程適用。
