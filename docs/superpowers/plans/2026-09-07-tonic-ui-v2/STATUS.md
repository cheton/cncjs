...
- Active task: **A3a Autolevel forms** — A2 Tool is complete; A3a is now eligible.
...
- Next eligible task: **A3a Autolevel forms**。S1–S4、A1b 與 A2 已完成；G1–G7、C1–C4 已完成，G1-B01 已由使用者重新界定 scope 後解除。
...
| A3a | [Autolevel forms](06-motion-widgets.md) | A1b | in_progress | current root session / 2026-09-20 | Dialog callback/Tonic/Form implementation started; ApplyView file/pipeline/PubSub conversion remains. |
