...
- [STATUS](STATUS.md)：BR0 為 waived；R0 non-browser baseline、D1、D2、D3 已完成；D4 為下一個 eligible task，browser gaps 依 waiver 延後至 R6。F1 的開始 HEAD `21c288dc`；本次 BR0 resume 開始於 `62ea82ca`，目前保留小型 synthetic fixtures、checkpoint docs、durable artifacts、D1/D2/D3 modules/tests、Jest mapper 更新與 `Connection.jsx` selector patch；runtime-generated large G-code/watch-tree payload 不追蹤。BR0-B06 已解決，BR0-B07/B08 與 `br0-20260913-200600` evidence 已保存。
